...
func easyjson6601e8cdDecodeTmpEasyjson(in *jlexer.Lexer, out *Settings) {
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "default_deadline_seconds":
			out.DefaultDeadlineSeconds = int64(in.Int64())
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson6601e8cdEncodeTmpEasyjson(out *jwriter.Writer, in Settings) {
	...
	_ = first
	{
		const prefix string = ",\"default_deadline_seconds\":"
		out.RawString(prefix[1:])
		out.Int64(int64(in.DefaultDeadlineSeconds))
	}
	out.RawByte('}')
}
